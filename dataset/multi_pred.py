...
class PredDataset(IndexableDataset):
    def __init__(self, char_begins, char_ends, contexts, word2id, word_freq, **kwargs):
        ...
        self._mention_begin = []
        self._mention_end = []
        self.construct_dataset(char_begins,char_ends,contexts)
...
def setup_datastream(char_begins, char_ends, contexts, config, word2id, word_freq):
    dataset = PredDataset(char_begins, char_ends, contexts, word2id, word_freq)
